...
public class TSmmParser extends Parser {
		...
		try {
			...
			case 3:
				...
				do {
					...
					_localctx.recordF.add(((TypeContext)_localctx).r1.ast);
					}
					}
					setState(231); 
					_errHandler.sync(this);
	...
	public final Simple_typeContext simple_type() throws RecognitionException {
		...
		try {
			...
			case T__32:
				...
				setState(239);
				match(T__32);
				((Simple_typeContext)_localctx).ast =  new NumberType();
				}
				break;
			case T__33:
				enterOuterAlt(_localctx, 3);
	...
	public final RecordFieldContext recordField() throws RecognitionException {
		...
		try {
			...
			setState(249);
			match(T__22);
			((RecordFieldContext)_localctx).ast =  new RecordField(((RecordFieldContext)_localctx).t1.ast, (((RecordFieldContext)_localctx).ID!=null?((RecordFieldContext)_localctx).ID.getText():null));
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final FunctionDefinitionContext functionDefinition() throws RecognitionException {
		...
		try {
			...
			case T__37:
				...
				setState(270);
				match(T__37);
				((FunctionDefinitionContext)_localctx).returnType =  new VoidType();
				}
				break;
			case T__31:
			case T__32:
